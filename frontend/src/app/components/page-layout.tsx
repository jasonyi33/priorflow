...
export default function PageLayout({ children, header }: PageLayoutProps) {
  return (
    <div className="flex flex-col relative w-full gap-1 min-h-full">
      <div className="flex items-center lg:items-baseline gap-2.5 md:gap-4 px-4 md:px-6 py-3 md:pb-4 lg:pt-7 ring-2 ring-pop sticky top-0 bg-background z-10">
        ...
        <h1 className="text-xl lg:text-4xl font-['Inter',sans-serif] font-bold tracking-tight leading-[1] mb-1">
          {header.title}
        </h1>
        {header.description && (
