      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="flex items-center gap-3 mb-3">
            <PriorFlowLogo className="size-10 text-foreground" />
            <span className="text-2xl font-bold tracking-tight">PriorFlow</span>
          </div>
          <p className="text-xs text-muted-foreground tracking-[0.2em] uppercase">Prior Authorization Platform</p>
        </div>
        ...
        <p className="text-center text-[10px] text-muted-foreground/40 mt-6 tracking-wider">
          PriorFlow v2.4.1 · HIPAA Compliant
        </p>
      </div>
    </div>
  );
